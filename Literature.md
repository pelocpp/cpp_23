...
---
  ...
  * Oleksandr Koval, &ldquo;*All C++20 core language features with examples*&rdquo;.</br>
    ...
    zugänglich. Alle Sprachneuerungen, die in C++ 20 Einzug gefunden haben,
    werden sehr elegant und präzise beschrieben.
...
---
  ...
  * Andreas Fertig, &ldquo;*Programming with C++20*&rdquo;.</br>
    ...
    Zweites Buch von Andreas Fertig, wiederum für fortgeschrittene Entwickler konzipiert,
