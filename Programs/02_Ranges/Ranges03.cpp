...
namespace Cpp20RangesViewImplementationExampleTest_01
{
...
namespace views {
    inline Cpp20RangesViewImplementationExampleTest_01::details::custom_take_range_adaptor custom_take;
}

// namespace rg = std::ranges;

namespace Cpp20RangesViewImplementationExampleTest_02
{
...
namespace views
{
    Cpp20RangesViewImplementationExampleTest_02::details::custom_take_range_adaptor custom_take2;
}

void ranges_ex_09_test_custom_view_01()
{
    using namespace Cpp20RangesViewImplementationExampleTest_01;

    auto is_even = [](int const n) { return n % 2 == 0; };

    const std::vector<int> n{ 2, 3, 5, 6, 7, 8, 9 };

    auto v = n | std::ranges::views::filter(is_even) | views::custom_take(2);
...
{
    using namespace Cpp20RangesViewImplementationExampleTest_02;

    auto is_even = [](int const n) { return n % 2 == 0; };

    const std::vector<int> n{ 2, 3, 5, 6, 7, 8, 9 };

    auto v = n | std::ranges::views::filter(is_even) | views::custom_take2(2);
...
void ranges_ex_09_test_custom_view_03()
{
    ...
    auto v = n | std::ranges::views::filter(is_even) | std::ranges::views::reverse | views::custom_take(2);
